...
-- lu_mdc.mdc_name,
-- lu_mdc.mdc_short,
case when lu_mdc.mdc in('0') then 1 else 0 end mdc_NotAssign,
case when lu_mdc.mdc in('1') then 1 else 0 end mdc_Nervous,
case when lu_mdc.mdc in('2') then 1 else 0 end mdc_Eye,
case when lu_mdc.mdc in('3') then 1 else 0 end mdc_ENTM,
case when lu_mdc.mdc in('4') then 1 else 0 end mdc_Respiratory,
case when lu_mdc.mdc in('5') then 1 else 0 end mdc_Circulatory,
case when lu_mdc.mdc in('6') then 1 else 0 end mdc_Digestive,
case when lu_mdc.mdc in('7') then 1 else 0 end mdc_Hepatobiliary,
case when lu_mdc.mdc in('8') then 1 else 0 end mdc_MusculoSkeletal,
case when lu_mdc.mdc in('9') then 1 else 0 end mdc_Skin,
case when lu_mdc.mdc in('10') then 1 else 0 end mdc_Endocrine,
case when lu_mdc.mdc in('11') then 1 else 0 end mdc_KidneyUrinary,
case when lu_mdc.mdc in('12') then 1 else 0 end mdc_MaleReprod,
case when lu_mdc.mdc in('13') then 1 else 0 end mdc_FemaleReprod,
case when lu_mdc.mdc in('14') then 1 else 0 end mdc_Pregnancy,
case when lu_mdc.mdc in('15') then 1 else 0 end mdc_Newborns,
case when lu_mdc.mdc in('16') then 1 else 0 end mdc_Blood,
case when lu_mdc.mdc in('17') then 1 else 0 end mdc_Myeloproliferative,
case when lu_mdc.mdc in('18') then 1 else 0 end mdc_InfectParasitic,
case when lu_mdc.mdc in('19') then 1 else 0 end mdc_Mental,
case when lu_mdc.mdc in('20') then 1 else 0 end mdc_AlcoholDrug,
case when lu_mdc.mdc in('21') then 1 else 0 end mdc_Poisoning,
case when lu_mdc.mdc in('22') then 1 else 0 end mdc_Burns,
case when lu_mdc.mdc in('23') then 1 else 0 end mdc_HlthSvcs,
case when lu_mdc.mdc in('24') then 1 else 0 end mdc_MultiTrauma,
case when lu_mdc.mdc in('25') then 1 else 0 end mdc_HIV,
case when lu_mdc.mdc in('.') then 1 else 0 end mdc_Missing,
---------- recency
